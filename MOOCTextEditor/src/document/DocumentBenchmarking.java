	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for (int trial = 0; trial < trials; trial++) {
				 ...
				 fleshScore = basic.getFleschScore();
			}
			long endTimeBasic = System.nanoTime();
			System.out.print((double)((endTimeBasic - startTimeBasic) / 1000000000) + "\t");
			long startTimeEfficient = System.nanoTime();
			for (int trial = 0; trial < trials; trial++) {
				 EfficientDocument efficient = new EfficientDocument(text);
				 fleshScore = efficient.getFleschScore();
			}
			long endTimeEfficient = System.nanoTime();
			System.out.print((double)((endTimeEfficient - startTimeEfficient) / 1000000000) + "\n");
		}
