...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
		...
		boolean success = shortList.add("C");
		assertEquals("testAddEnd: check C is added", "C", shortList.get(2));
		assertEquals("testAddEnd: check element 0 is correct ", "A", shortList.get(0));
	}
	...
	{
		// TODO: implement this test
		boolean success1 = shortList.add("C");
		assertEquals("testAddEnd: check size is correct ", 3, shortList.size());
		boolean success2 = emptyList.add(1);
		assertEquals("testAddEnd: check size is correct ", 1, emptyList.size());
	}
